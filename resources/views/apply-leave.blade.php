			...
			<div class="form-group">
				...
				<div class="col-sm-12">
					...
					<textarea name="reason_for_leave" class="form-control" id="inputBody" rows="8" data-gramm="true"
							  ...
							  style="z-index: auto; position: relative; line-height: 26.6667px; font-size: 14px; transition: none; overflow: auto; background: transparent !important;">{{ old('reason_for_leave') }}</textarea>
					<div>
