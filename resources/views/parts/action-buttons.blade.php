@if (Auth::user()->is_admin == true)
    ...
    <a href="{{ route('all-admins') }}" class="btn btn-default btn-md"><i class="fa fa-user-circle"></i> All Admins</a>
    <a href="{{ route('all-staff-members-payroll') }}" class="btn btn-primary btn-md"><i class="fa fa-list-ul"></i> View Payrolls</a>
